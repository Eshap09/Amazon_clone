    ...
    return (
        <div className="login">
            ...
            <div className="login__container">
                ...
                <p>
                    By signing in you agree to Amazon's condition of code of conduct, 
                    click here to see our privacy ntice, our cookies notice and outline notice
                </p>
